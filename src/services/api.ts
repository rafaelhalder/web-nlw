...
export const getSubscribeToEventUrl = () => {
  ...
  return `https://server-nlw-w9yt.onrender.com/subscriptions`
}
...
export const getAccessInviteLinkUrl = (subscriberId: string,) => {
  ...
  return `https://server-nlw-w9yt.onrender.com/invites/${subscriberId}`
}
...
export const getGetRankingUrl = () => {
  ...
  return `https://server-nlw-w9yt.onrender.com/ranking`
}
...
export const getGetSubscriberInviteCountUrl = (subscriberId: string,) => {
  ...
  return `https://server-nlw-w9yt.onrender.com/subscribers/${subscriberId}/ranking/count`
}
...
export const getGetSubscriberInviteClicksUrl = (subscriberId: string,) => {
  ...
  return `https://server-nlw-w9yt.onrender.com/subscribers/${subscriberId}/ranking/clicks`
}
...
export const getGetSubscriberRankingPositionUrl = (subscriberId: string,) => {
  ...
  return `https://server-nlw-w9yt.onrender.com/subscribers/${subscriberId}/ranking/position`
}
